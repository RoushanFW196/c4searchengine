...
export const Seacrhpage=()=>{
    ...
    return(
        <div>
            <div className="seacrhpage-navbar">
                <span>
                ...
                <span>
                    <input type="text"/>
                    <input type="submit" value="seacrch"/>
                </span>
            </div>


            <div className="seacrhpage-button">
                <span><button>Sort A-Z</button></span>
                <span><button>Sort Z-A</button></span>
                <span><button>Sort by date(asc)</button></span>
                <span><button>Sort by date(desc)</button></span>
                <span><button>Sort by quality(asc)</button></span>
                <span><button>Sort by quality(desc)</button></span>
                <span><button>Filter Explicit</button></span>
            </div>
